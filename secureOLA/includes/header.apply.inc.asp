...
%>
    ...
    <script src="<%=SITE_ROOT_PATH%>scripts/jquery-ui.js"></script>
    <link rel="stylesheet" type="text/css" href="<%=SITE_ROOT_PATH%>styles/main.css">
    <link rel="shortcut icon" href="<%=SITE_ROOT_PATH%>sfavicon.ico">
</head>
<body>
    <nav class="apply">
    ...
    <div class="wrapper">
       <a href="#" id="togglemenu" class="icon-menu">Menu</a>
          ...
          <a href="<%=SITE_ROOT_PATH%>index.asp" class="logo" alt="<%=COMPANY_NAME%>"></a>
